	...
	<div class="card card-custom">
		<div class="card-header">
			<div class="card-title">
				...
				<h3 class="card-label">List of Couse</h3>
			</div>
		...
		<div class="card-body">
			...
			<!--begin: Datatable-->
			<!--begin: Datatable-->
			<table class="table table-bordered table-hover table-checkable" id="kt_datatable_courseList" style="margin-top: 13px !important">
				<thead>
					<tr>
						<th>Record ID</th>
						<th>S#</th>
