    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">Edit Course Category</h3>
            </div>
                                       ...
                                       <div class="form-group row fv-plugins-icon-container">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                ...
                                                foreach ($coursArr as $key => $rowData) {
                                                    if($rowData->id==$data->course_id){
                                                        ?>
                                                        <option select value="{{$rowData->id}}">{{$rowData->name}}</option>
                                                        <?php
                                                    }else{
                                                        ?>
                                        ...
                                        <div class="form-group row fv-plugins-icon-container">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input class="form-control form-control-solid form-control-lg" name="name_cat" type="text" value="{{$data->name_cat}}">
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                        </div>
                                        <!--end::Group-->
